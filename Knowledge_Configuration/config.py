...
class KGEArgParser(ArgumentParser):
    ...
    def __init__(self):
        ...
        self.basic_group.add_argument(
            '--save_path',
            type=str,
            # default='./result/checkpoint/transe/',  # train
            default='./result/checkpoint/pred',  # predict
        ...
        self.basic_group.add_argument(
            ...
            type=str,
            # default=None,  # train
            default='./result/checkpoint/transe/transe_data2023_d_400_g_19.9_e_gpu_r_gpu_l_Logsigmoid_lr_0.01_0.1_KGE',  # predict
        ...
        self.basic_group.add_argument(
            ...
            default='data2023',
            choices=[
                'FB15k', 'FB15k-237', 'wn18', 'WN18RR', 'wikikg2', 'wikikg90m', 'OpenBG500', 'data2023'
            ],
            help='Dataset name.')
        ...
        self.basic_group.add_argument(
            ...
            type=bool,
            # default=True,  # train
            default=False,  # predict
            # action='store_true',
            help='Evaluate the model on' \
        ...
        self.train_group.add_argument(
            '--eval_interval', type=int, default=10000, help='Print ' \
