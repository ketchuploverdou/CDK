...
def main():
    ...
    if args.test:
        evaluate(
            ...
            args.save_path,
            data_mode=args.data_name)
    evaluate(model, valid_loader, 'valid', filter_dict if args.filter_eval else None, data_mode=args.data_name)
    paddle.save(model.state_dict(), os.path.join(args.save_path, "params.pdparams"))
